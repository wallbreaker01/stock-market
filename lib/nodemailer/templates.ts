...
<head>
    ...
    <meta name="format-detection" content="telephone=no">
    <meta name="x-apple-disable-message-reformatting">
    <title>Hourly Stock Alert</title>
    <style type="text/css">
        @media (prefers-color-scheme: dark) {
    ...
    <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: #050505;">
        <tr>
            <td align="center" style="padding: 40px 20px;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="email-container" style="max-width: 700px; background-color: #141414; border-radius: 8px; border: 1px solid #30333A;">
                    <tr>
                        <td class="mobile-padding" style="padding: 32px 40px 40px 40px;">
                            <h1 class="mobile-title dark-text" style="margin: 0 0 10px 0; font-size: 24px; font-weight: 600; color: #FDD458; line-height: 1.2;">
                                Hourly Stock Alert
                            </h1>
                            <p class="mobile-text dark-text-secondary" style="margin: 0 0 24px 0; font-size: 16px; line-height: 1.6; color: #CCDADC;">
                                Hi {{name}}, here is your hourly snapshot for <strong>{{date}}</strong>.
                            </p>
                            <div style="background-color: #0B0B0B; border: 1px solid #30333A; border-radius: 8px; padding: 16px;">
                                {{content}}
                            </div>
                            <p class="mobile-text dark-text-secondary" style="margin: 24px 0 0 0; font-size: 14px; line-height: 1.5; color: #9CA3AF;">
                                You can manage alerts from your Watchlist page.
                            </p>
                        </td>
                    </tr>
                </table>
